...
export default function App(props) {
  ...
  const approve = e => {
    ...
    employeeService.Approveproject(setSnackbaropen, setSnackbartype, setSnackbarmsg, props.match.params.id);
  ...
  const withhold = e => {
    ...
    employeeService.Pendingproject(setSnackbaropen, setSnackbartype, setSnackbarmsg, props.match.params.id);
    ...
    <div>
      ...
      >
        ...
        <Paper elevation={4} className={fixedHeightPaper} alignItems='center' >
          ...
          <Grid item xs={12} className={classes.buttns} >
            <Typography className={classes.paper1}>
              {projectdetails.projectstatus == "approved" || projectdetails.projectstatus == "alloted" ? <div></div> :
                <div>
                  <Controls.Button
                    type="submit"
                    onClick={approve}
