...
export default function EmployeeForm(props) {
    ...
    const validate = (fieldValues = values) => {
        ...
        if ('nameofservice' in fieldValues)
            temp.nameofservice = (fieldValues.nameofservice.length !== 0 && fieldValues.nameofservice.length <= 25) ? "" : "This field is required."
        if ('fromdate' in fieldValues)
            temp.fromdate = fieldValues.fromdate.length != 0 ? "" : "This field is required."
